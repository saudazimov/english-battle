(function () {
  ...
  const messages = {
    uz: {
      ...
      "login.subtitle": "Admin bergan login va parolni kiriting",
      "login.identifier": "Login",
      "login.identifierPlaceholder": "Masalan: IL-7K3M-482Q",
    ...
    en: {
      ...
      "login.back": "Back", "login.title": "Log in to your account", "login.subtitle": "Enter the login and password given by your administrator", "login.identifier": "Login", "login.identifierPlaceholder": "For example: IL-7K3M-482Q", "login.phone": "Phone number", "login.password": "Password", "login.passwordPlaceholder": "Your password", "login.submit": "Log in", "login.forgot": "Forgot password?", "login.noAccount": "Don’t have an account?", "login.signup": "Sign up",
    ...
    ru: {
      ...
      "login.back": "Назад", "login.title": "Войдите в аккаунт", "login.subtitle": "Введите логин и пароль, выданные администратором", "login.identifier": "Логин", "login.identifierPlaceholder": "Например: IL-7K3M-482Q", "login.phone": "Номер телефона", "login.password": "Пароль", "login.passwordPlaceholder": "Ваш пароль", "login.submit": "Войти", "login.forgot": "Забыли пароль?", "login.noAccount": "Нет аккаунта?", "login.signup": "Регистрация",
